...
class SigmaaldrichAuthPriceSelenium():
    locale = 'CH'
    lang = 'en'
    ...
    def __init__(self,url=None,userName=None,password=None):
        ...
        self.logFile = datetime.now().strftime("SigmadrichAuthPriceSelenium_%Y_%m_%d-%I-%M-%S_%p")
        with open(f'{self.logFile}.log','w') as f:
            f.write('SIGMA AUTH PRICE SELENIUM LOGS\n')
    ...
    def login(self):
        ...
        #self.driver.get('https://whatismyip.com')
    ...
    def getProduct(self):
        try:
            ...
            try:
                ...
                description +=" \n "+ self.driver.find_element(By.XPATH,"//div[contains(@class,'MuiTypography-root jss282 MuiTypography-body1')]").text
            except:
                description = ''
            #Product Codes
            productCodes = []
    ...
    def main(self):
        try:
            ...
            print(e)
            self.driver.close()
# t = SigmaaldrichAuthPriceSelenium('https://www.sigmaaldrich.com/CH/en/product/sigma/ups2','aaron.ueckermann@axiomdata.io','AxiomPassword123!')
# print(t.main())